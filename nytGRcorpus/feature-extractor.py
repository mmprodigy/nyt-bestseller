...
d = '</GoodreadsResponse>'
dataList =  data.split(d)[546:1000] #List of strings representing dictionairies/books
print len(dataList)
...
average rating [10], rating_count [11], popular_shelves (shelves with count geq 50) [12],  reviews,bestSeller,
'''
book_features = []
